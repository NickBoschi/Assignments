...
// if (addButton != null) {
//     addButton.classList.add('is-fullwidth');
// }
...
export default {
  data() {
    return {
      ...
      type: '',
      workouts: [
        { id: id++, desc: 'Workout 1', dur: '12 min', date: '2022-10-8', type: 'Run' },
        { id: id++, desc: 'Workout 2', dur: '18 hr', date: '2222-44-66', type: 'Cardio' },
        { id: id++, desc: 'Workout 3', dur: '2 sec', date: '0101-01-01', type: 'Aerobic' }
      ],
      showModal: false
    }
  },
    ...
    <div v-if="showModal" id="modal" class="modal is-active">
        ...
        <div class="modal-card">
            ...
            <footer class="modal-card-foot">
                ...
                <button class="button" @click="modalToggle">Cancel</button>
            </footer>
        </div>
    </div>
